        ...
        $user->assignRole('exhibitor');
           ...
           // Download and save each file
            ...
            Business::create([
                ...
                'type_of_business' => json_encode(is_array($validated['business_type'] ?? []) ? array_map(function($type) use ($validated) {
                    return $type === 'Others' ? $validated['field_6c3a5cd'] ?? '' : $type;
                }, $validated['business_type']) : [($validated['business_type'] === 'Others' ? $validated['field_6c3a5cd'] ?? '' : $validated['business_type'] ?? '')]),
