...
! function (e, t) {
    ...
    var t, o, n, i, r = function (e, t) {
        ...
        s = function (e, t) {
            ...
            if (Array.prototype.map && e.map === Array.prototype.map) i = Array.prototype.map.call(e, function (e) {
                ...
                for (o = 0; o < r; o++) callback_params = n, callback_params.splice(0, 0, e[o]), i.push(t.apply(this, callback_params));
            return i
        },
        a = function (e) {
            var t, o = [];
        ...
        l = function (e, t) {
            var o, n, i, r, s;
            for (o = 0; o < e.length; o++) e[o] instanceof google.maps.LatLng || (e[o].length > 0 && "object" == typeof e[o][0] ? e[o] = l(e[o], t) : e[o] = (n = e[o], i = t, r = void 0, s = void 0, r = n[0], s = n[1], i && (r = n[1], s = n[0]), new google.maps.LatLng(r, s)));
            return e
        },
        p = function (e, t) {
            e = e.replace("#", "");
        ...
        c = (t = document, o = function (e) {
            ...
            if ("string" == typeof e.el || "string" == typeof e.div ? g.indexOf("#") > -1 ? this.el = p(g, e.context) : this.el = function (e, t) {
                    var o = e.replace(".", "");
                    return "jQuery" in this && t ? $("." + o, t)[0] : document.getElementsByClassName(o)[0]
                }.apply(this, [g, e.context]) : this.el = g, void 0 === this.el || null === this.el) throw "No element defined.";
            for (window.context_menu = window.context_menu || {}, window.context_menu[s.el.id] = {}, this.controls = [], this.overlays = [], this.layers = [], this.singleLayers = {}, this.markers = [], this.polylines = [], this.routes = [], this.polygons = [], this.infoWindow = null, this.overlay_el = null, this.zoom = e.zoom, this.registered_events = {}, this.el.style.width = e.width || this.el.scrollWidth || this.el.offsetWidth, this.el.style.height = e.height || this.el.scrollHeight || this.el.offsetHeight, google.maps.visualRefresh = e.enableNewStyle, n = 0; n < c.length; n++) delete e[c[n]];
            for (1 != e.disableDefaultUI && (x = r(x, C)), M = r(x, e), n = 0; n < a.length; n++) delete M[a[n]];
            ...
            var O = function (e, t) {
                ...
                for (var i in n)
                    if (n.hasOwnProperty(i)) {
                        var r = n[i];
                        o += '<li><a id="' + e + "_" + i + '" href="#">' + r.title + "</a></li>"
            ...
            this.buildContextMenu = function (e, t) {
                ...
                for (o in e.options)
                    ...
                    } n.id = "gmaps_context_menu", n.style.display = "none", n.style.position = "absolute", n.style.minWidth = "100px", n.style.background = "white", n.style.listStyle = "none", n.style.padding = "8px", n.style.boxShadow = "2px 2px 6px #ccc", p("gmaps_context_menu") || t.body.appendChild(n);
            ...
            for (n = 0; n < W.length; n++) ! function (e, t, o) {
                e[o] = function () {
    ...
    return c.prototype.createControl = function (e) {
        ...
        if (void 0 === e) {
            ...
            for (o = 0; o < e.length; o++) {
                ...
                if (n > -1)(i = this.markers[n]).setMap(null), this.markerClusterer && this.markerClusterer.removeMarker(i), c.fire("marker_removed", i, this)
            }
        ...
        return t.setMap(this.map), null != e.auto_show && (o = e.auto_show), t.onAdd = function () {
            ...
            var n, i, r = this.getPanes(),
                s = ["contextmenu", "DOMMouseScroll", "dblclick", "mousedown"];
            r[e.layer].appendChild(o);
            for (var a = 0; a < s.length; a++) n = o, i = s[a], google.maps.event.addDomListener(n, i, function (e) {
        ...
        for (var s = new google.maps.Polyline(r), a = ["click", "dblclick", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "rightclick"], l = 0; l < a.length; l++) ! function (t, o) {
        ...
        for (var t = new google.maps.Circle(e), o = ["click", "dblclick", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "rightclick"], n = 0; n < o.length; n++) ! function (t, o) {
            e[o] && google.maps.event.addListener(t, o, function (t) {
                e[o].apply(this, [t])
            })
        }(t, o[n]);
        ...
        e.bounds = t;
        for (var o = new google.maps.Rectangle(e), n = ["click", "dblclick", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "rightclick"], i = 0; i < n.length; i++) ! function (t, o) {
            e[o] && google.maps.event.addListener(t, o, function (t) {
                e[o].apply(this, [t])
            })
        }(o, n[i]);
        ...
        var t = !1;
        e.hasOwnProperty("useGeoJSON") && (t = e.useGeoJSON), delete e.useGeoJSON, e = r({
            map: this.map
        }, e), 0 == t && (e.paths = [e.paths.slice(0)]), e.paths.length > 0 && e.paths[0].length > 0 && (e.paths = a(s(e.paths, l, t)));
        for (var o = new google.maps.Polygon(e), n = ["click", "dblclick", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "rightclick"], i = 0; i < n.length; i++) ! function (t, o) {
            e[o] && google.maps.event.addListener(t, o, function (t) {
                e[o].apply(this, [t])
            })
        }(o, n[i]);
        ...
        t.origin = /string/.test(typeof e.origin) ? e.origin : new google.maps.LatLng(e.origin[0], e.origin[1]), t.destination = /string/.test(typeof e.destination) ? e.destination : new google.maps.LatLng(e.destination[0], e.destination[1]), t.travelMode = n, t.unitSystem = i, delete t.callback, delete t.error;
        var o = [];
        ...
        (e = r({
            ...
            path: !1,
            samples: 256
        }, e)).locations.length > 0 && e.locations[0].length > 0 && (e.locations = a(s([e.locations], l, !1)));
        var t = e.callback;
        delete e.callback;
        ...
        var o, n = "string" == typeof t.panel ? document.getElementById(t.panel.replace("#", "")) : t.panel;
        t.panel = n, t = r({
            map: this.map
        }, t), o = new google.maps.DirectionsRenderer(t), this.getRoutes({
            origin: e.origin,
        ...
        if (e.origin && e.destination) this.getRoutes({
            ...
            callback: function (t) {
                if (t.length > 0 && e.start && e.start(t[t.length - 1]), t.length > 0 && e.step) {
                    var o = t[t.length - 1];
                    if (o.legs.length > 0)
                        for (var n, i = o.legs[0].steps, r = 0; n = i[r]; r++) n.step_number = r, e.step(n, o.legs[0].steps.length - 1)
                }
        ...
        if (e.origin && e.destination) this.getRoutes({
                ...
                if (o.length > 0 && e.start && e.start(o[o.length - 1]), o.length > 0 && e.step) {
                    ...
                    if (n.legs.length > 0)
                        for (var i, r = n.legs[0].steps, s = 0; i = r[s]; s++) {
                            ...
                            e.hasOwnProperty("icons") && (a.icons = e.icons), t.drawPolyline(a), e.step(i, n.legs[0].steps.length - 1)
                        }
                }
            ...
            for (var o, n = e.route.legs[0].steps, i = 0; o = n[i]; i++) {
                ...
                e.hasOwnProperty("icons") && (r.icons = e.icons), t.drawPolyline(r), e.step(o)
            }
    }, c.Route = function (e) {
        ...
        if (r)
            for (d = 0; d < r.length; d++) {
                var u = [];
                r[d].featureType && u.push("feature:" + r[d].featureType.toLowerCase()), r[d].elementType && u.push("element:" + r[d].elementType.toLowerCase());
                for (var m = 0; m < r[d].stylers.length; m++)
                    for (var f in r[d].stylers[m]) {
                        var y = r[d].stylers[m][f];
                        "hue" != f && "color" != f || (y = "0x" + y.substring(1)), u.push(f + ":" + y)
                    }
                var v = u.join("|");
                "" != v && o.push("style=" + v)
            }
        ...
        for (var o = ["closeclick", "links_changed", "pano_changed", "position_changed", "pov_changed", "resize", "visible_changed"], n = r({
                visible: !0
            }, e), i = 0; i < o.length; i++) delete n[o[i]];
        var s = new google.maps.StreetViewPanorama(t, n);
        for (i = 0; i < o.length; i++) ! function (t, o) {
            e[o] && google.maps.event.addListener(t, o, function () {
                e[o].apply(this)
            })
        }(s, o[i]);
    ...
    }, c.custom_events = ["marker_added", "marker_removed", "polyline_added", "polyline_removed", "polygon_added", "polygon_removed", "geolocated", "geolocation_failed"], c.on = function (e, t, o) {
        if (-1 == c.custom_events.indexOf(e)) return t instanceof c && (t = t.map), google.maps.event.addListener(t, e, o);
        var n = {
            handler: o,
            eventName: e
        };
        ...
        if (-1 == c.custom_events.indexOf(e)) return t instanceof c && (t = t.map), google.maps.event.addListenerOnce(t, e, o)
        ...
        if (-1 == c.custom_events.indexOf(e)) google.maps.event.trigger(t, e, Array.prototype.slice.apply(arguments).slice(2));
            ...
            for (var n = o.registered_events[e], i = 0; i < n.length; i++) r = n[i].handler, s = o, a = t, r.apply(s, [a]);
        var r, s, a
