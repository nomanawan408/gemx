...
! function () {
    ...
    "undefined" == typeof Chart ? console.warn("Can not find Chart object.") : (t.prototype.beforeDatasetsUpdate = function (t) {
        ...
        for (var e = this.ctx, i = this.chartInstance, o = t._meta[Object.keys(t._meta)[0]], a = 0, s = 0; s < o.data.length; s++) {
            ...
            if (0 !== n.circumference || this.showZero) {
                ...
                if ("function" == typeof (p = this.fontColor) ? p = p({
                        ...
                        dataset: t,
                        index: s
                    }) : "string" != typeof p && (p = p[s] || this.options.defaultFontColor), this.arc) u || (u = (c + n.outerRadius) / 2), e.fillStyle = p, e.textBaseline = "middle", this.drawArcText(h, u, n, this.overlap);
                else {
        ...
        var h = n += Math.PI / 2;
        if (n += ((i += Math.PI / 2) - ((s = this.measureText(t)).width / e + n)) / 2, o || !(i - n > r))
            if ("string" == typeof t)
                for (a.rotate(n), o = 0; o < t.length; o++) n = t.charAt(o), s = a.measureText(n), a.save(), a.translate(0, -1 * e), a.fillText(n, 0, 0), a.restore(), a.rotate(s.width / e);
