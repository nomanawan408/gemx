        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="relative mb-4">
                ...
                <input id="name" name="name" type="text" :value="old('name')" placeholder="Enter your name"
                    class="w-full px-4 py-3 rounded-lg border-2 border-gray-300 focus:outline-none focus:border-blue-500 transition duration-300" required autofocus autocomplete="name">
            ...
            <div class="relative mb-4">
                ...
                <input id="email" name="email" type="email" :value="old('email')" placeholder="Enter your email"
                    class="w-full px-4 py-3 rounded-lg border-2 border-gray-300 focus:outline-none focus:border-blue-500 transition duration-300" required autocomplete="username">
            ...
            <div class="relative mb-4">
                ...
                <input id="password" name="password" type="password" placeholder="Enter your password"
                    class="w-full px-4 py-3 rounded-lg border-2 border-gray-300 focus:outline-none focus:border-blue-500 transition duration-300" required autocomplete="new-password">
